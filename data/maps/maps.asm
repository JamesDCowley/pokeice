...
MapGroup_SilentTown:
	table_width MAP_LENGTH, MapGroup_SilentTown
	map SilentTown, TILESET_JOHTO, TOWN, LANDMARK_SILENT_TOWN, MUSIC_SILENT_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	...
	map SilentTownNeighborsHouse, TILESET_HOUSE, INDOOR, LANDMARK_SILENT_TOWN, MUSIC_SILENT_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route14, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_14, MUSIC_ROUTE_29, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map ProfAspenLab, TILESET_LAB, INDOOR, LANDMARK_SILENT_TOWN, MUSIC_PROF_ELM, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Indigo:
	...
	map HallOfFame, TILESET_ICE_PATH, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_SILENT_TOWN, TRUE, PALETTE_DAY, FISHGROUP_SHORE
