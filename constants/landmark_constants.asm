...
; Johto landmarks
	const LANDMARK_SILENT_TOWN		; 01
	const LANDMARK_ROUTE_14			; 02
	const LANDMARK_PUREN_CITY		; 03
	const LANDMARK_ROUTE_15			; 04
	const LANDMARK_EVERGREEN_TOWN	; 05
	const LANDMARK_EVERGREEN_FOREST	; 06
	const LANDMARK_ROUTE_21			; 07
	const LANDMARK_EBONY_TOWN		; 08
	const LANDMARK_ROUTE_22			; 09
	const LANDMARK_ROUTE_23			; 0a
	const LANDMARK_ICICLE_LAKE		; 0b

; Needed for other maps
; removing these will break other stuff

DEF KANTO_LANDMARK EQU const_value
	const LANDMARK_BATTLE_TOWER		 ; 0c
	const LANDMARK_INDIGO_PLATEAU	 ; 0d
	const LANDMARK_NEW_BARK_TOWN     ; 0e
